...
[![npm shield](https://img.shields.io/npm/v/imdb)](https://www.npmjs.com/package/imdb)
...
A full reference for this library is available [here](https://github.com/devalog/fern-sdk-test/blob/HEAD/./reference.md).
...
```typescript
import { DevinApiClient } from "imdb";
...
```typescript
import { DevinApiError } from "imdb";
